...
export function FkColumnMenu({
  ...
  return (
    <>
      <Button ref={triggerRef} type="button" variant="outline" size="sm" onClick={() => setOpen((o) => !o)} className="gap-1.5">
      ...
      {open && createPortal(
        <>
          ...
          <div
            role="menu"
            className="fixed z-[9999] w-60 overflow-hidden rounded-xl border border-border bg-card shadow-xl"
